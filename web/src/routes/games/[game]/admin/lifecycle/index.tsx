...
export default function Lifecycle() {
  ...
  async function handleUpdateLifecycle() {
    if (!game.data) return;
    updateLifecycleMutation.mutate({ game_id: game.data.id, lifecycle: script() });
  }
      ...
      <div class="flex-1 flex flex-col items-center p-3 lg:p-6 lg:pb-3 relative">
        <div class="flex-1 flex flex-col w-full">
          <h2 class="h-12 shrink-0 flex items-center border-b border-b-layer-content/10 font-bold space-x-2">
            ...
            />
            <Button size="sm" level="primary" onClick={handleUpdateLifecycle} loading={saving()}>
            ...
            <Show when={hasLifecycle()}>
              ...
              >
                <Card contentClass="p-2 flex flex-col space-y-2 max-w-96">
                  ...
                  <Button level="primary" size="sm" class="self-end" onClick={handleDeleteLifecycle}>
