    ...
    <>
      <div class="flex flex-row space-x-2 justify-between">
        ...
        <Select
          ...
          onValueChange={v => props.onInstituteChanged?.(v.items.at(0)?.value || null)}
        />
      </div>
    </>
  )
...
export default function () {
  ...
  const [showHiddenTeams, setShowHiddenTeams] = createSignal(false)
            ...
            <Show when={showChallengeDetail()}>
              <div class="absolute bottom-2 left-2 right-2">
                <ChartOperations
                  ...
                  onShowHiddenTeams={setShowHiddenTeams}
                  onInstituteChanged={setSelectedInstituteId}
                />
              </div>
            </Show>
          </Card>
          ...
          <Show
            ...
            fallback={
              <>
                ...
                <TeamRanks teams={teams()} page={page()} pageSize={pageSize()} showTime={!showLargePanel()} />
              </>
            }
          >
